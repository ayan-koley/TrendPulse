...
import { platformsTable, countryEnum } from './index.ts'
...
export const hashtagsTable = pgTable('hashtags', {
    ...
    engagement_score: integer('engagement_score').default(0).notNull(),
    growth_rate: numeric('growth_rate', { precision: 5, scale: 2 }).default('0'),
